...
import { Text, View, TextInput, TouchableOpacity, Dimensions, Image, KeyboardAvoidingView, ActivityIndicator, SafeAreaView } from 'react-native';
		...
		return (
			<>
				...
				<SafeAreaView style={[styles.bottomSafeArea]}>
					...
					<KeyboardAvoidingView style={{ ...styles.container, backgroundColor: '#fff' }} behavior="padding" enabled keyboardVerticalOffset={-60}>
